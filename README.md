...
- The web application is my [Item Catalog](https://github.com/BabaMalik/Linux_Project.git) created earlier in this Nanodegree program.
- The database server is [PostgreSQL](https://www.postgresql.org/).

You can visit http://204.236.208.97.xip.io/ or http://ec2-204-236-208-97.compute-1.amazonaws.com/ for the website deployed.
...
- To check port 2200 wether working or not by `ssh -i Malik.pem -p 2200 ubuntu@204.236.208.97` 
...
### Step 7: Create an SSH key pair for `grader`
  ...
  - Restart SSH: `sudo service ssh restart`
  - On the local machine, cheking if the grader account working or not by running this command : `ssh -i Malik.pem -p 2200 grader@204.236.208.97`.
...
- We need to change sqlite to postgresql create_engine in `__init__.py`,`Shoes_Setup.py` and `ShoeDB_init.py`,
   ```
...
- Click `Credentials`.
- Create an OAuth Client ID (under the Credentials tab), and add http://204.236.208.97.xip.io/ and 
 http://ec2-204-236-208-97.compute-1.amazonaws.com/ as authorized JavaScript 
origins.
- Add  http://204.236.208.97.xip.io/login, http://204.236.208.97.xip.io/gconnect, http://204.236.208.97.xip.io/callback
